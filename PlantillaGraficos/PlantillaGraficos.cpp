...
//Declarar una vetana
GLFWwindow* window;
float posXTriangulo = 0.0f, posYTriangulo = 0.0f, anguloTriangulo = 0.0f;
double tiempoActual, tiempoAnterior;
double velocidadTriangulo = 0.7;
double velocidadRotacion = 100;
...
void dibujar() {
	...
	glTranslatef(0.0, posYTriangulo, 0.0);

	glRotatef(anguloTriangulo, 0.0, 0.0, 1.0);
